...
public class Lvl2Spawner : MonoBehaviour {
    ...
    void SpawnDoor()
    {
        if (!DoorIsCreated)
        {
            ...
            var door2Spawn = GameObject.Find("Rm_1_T_Door").transform;
            door1 = Instantiate(Door, door2Spawn.position, door2Spawn.rotation) as GameObject;
    ...
    void SpawnDoor5()
    {
        if (!DoorIsCreated5)
        {
            ...
            Rm5_door2 = Instantiate(Door, Rm_5_door3Spawn.position, Rm_5_door3Spawn.rotation) as GameObject;
